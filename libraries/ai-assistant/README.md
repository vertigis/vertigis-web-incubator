...
The Assistant component allows users to interact with a web map using natural language and provides the main interface for engaging with AI agents. In this sample three different agents are configured:
